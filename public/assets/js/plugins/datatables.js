 ...
 *   https://datatables.net/download/#bs5/jq-3.7.0/dt-2.3.4/b-3.2.5/date-1.6.0/fc-5.0.5/fh-4.0.4/r-3.0.7/sp-2.3.5
 *
 * Included libraries:
 *   jQuery 3.7.0, DataTables 2.3.4, Buttons 3.2.5, DateTime 1.6.0, FixedColumns 5.0.5, FixedHeader 4.0.4, Responsive 3.0.7, SearchPanes 2.3.5
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5/jq-3.7.0/dt-2.3.4/b-3.2.5/date-1.6.0/fc-5.0.5/fh-4.0.4/r-3.0.7/sp-2.3.5",
